return function(Group, groups, colors, styles)
	...
	Group.new("Title", colors.ui_normal, colors.none, styles.bold + styles.underline)
	...
	Group.new("TabLineSel", colors.ui_important, colors.none, styles.bold + styles.underline)
