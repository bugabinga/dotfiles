...
local setup_workspaces = function()
  ...
  local dork_top_pane = dork_pane:split { cwd = dork_cwd, direction = 'Top', size = 0.69 }
  dork_top_pane:split { cwd = dork_cwd, direction = 'Left', size = 0.42 }
  ...
  local nvim_config_tab = dork_window:spawn_tab { cwd = dork_cwd .. '/neovim' }
  nvim_config_tab:set_title 'Neovim'
  nvim_config_tab:active_pane():split { cwd = dork_cwd .. '/neovim', direction = 'Left', size = 0.69 }
  ...
  local default_top_pane = default_pane:split { cwd = default_cwd, direction = 'Top', size = 0.69 }
